...
cprequire_test(["inline:com-chilipeppr-widget-yg"], function(myWidget) {
...
cpdefine("inline:com-chilipeppr-widget-yg", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-widget-yg", // Make the id the same as the cpdefine id
